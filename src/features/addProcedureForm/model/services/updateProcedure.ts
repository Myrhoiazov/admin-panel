...
export const updateProcedure = createAsyncThunk<Procedure, ThunkArg, ThunkConfig<string>>(
    ...
    async ({ id, file }, thunkApi) => {
        ...
        try {
            const response = await extra.apiPrivate.patch<Procedure>(`/procedures/${id}`, formData, {
                headers: {
